...
public abstract class AbstractSerialNettyClient extends AbstractSocketClient {
	private NettySocketClientHandler handler = new NettySocketClientHandler();

	private boolean isRunning = false;
	private boolean isChannelInactived = false;
	...
	public AbstractSerialNettyClient(String host, int port, int devtype) {
	...
	private void loopInit() {
		...
		while (true) {
			...
			if (isChannelInactived) {
				log("isChannelInactived" + ":yes;isRunning:" + isRunning + ";" + getClientInfo());
			}
			...
			if (isChannelInactived) {
				log("isChannelInactived" + ":watch;isRunning:" + isRunning + ";" + getClientInfo());
			}
		}
	}
