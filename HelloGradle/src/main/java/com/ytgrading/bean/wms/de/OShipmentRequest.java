...
public class OShipmentRequest {
	...
	public void setTordercode(String tordercode) {
		this.tordercode = tordercode;
	}
	...
	public void setDistrict(String disrict) {
	...
	public String getCusstomername() {
		return cusstomername;
	}
	public void setCusstomername(String cusstomername) {
		this.cusstomername = cusstomername;
	}
